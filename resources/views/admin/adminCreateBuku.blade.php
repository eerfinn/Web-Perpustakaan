            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="#"><div class="sb-nav-link-icon"><i class="fas fa-book"></i></div>Buku</a>
                        <a class="nav-link" href="#"><div class="sb-nav-link-icon"><i class="fas fa-book"></i></div>Kategori Buku</a>
                        <a class="nav-link" href="#"><div class="sb-nav-link-icon"><i class="fas fa-pencil"></i></div>Penulis</a>
                        <a class="nav-link" href="#"><div class="sb-nav-link-icon"><i class="fas fa-house"></i></div>Penerbit</a>
                        <a class="nav-link" href="#"><div class="sb-nav-link-icon"><i class="fas fa-hand"></i></div>Peminjaman</a>
                        <a class="nav-link" href="#"><div class="sb-nav-link-icon"><i class="fas fa-gear"></i></div>Pengaturan</a>
                        <a class="nav-link" href="#"><div class="sb-nav-link-icon"><i class="fas fa-right-from-bracket"></i></div>Logout</a>
                    </div>
                </div>
